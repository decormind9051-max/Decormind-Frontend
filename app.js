...
const kitchenSlides = [
  ...
  {
    image: 'https://images.unsplash.com/photo-1600585154350-9770c273c61c?auto=format&fit=crop&w=1200&q=80',
  ...
  {
    image: 'https://images.unsplash.com/photo-1519710884009-2f97c0c8bc97?auto=format&fit=crop&w=1200&q=80',
  ...
  {
    image: 'https://images.unsplash.com/photo-1505691723518-36a5ac3be353?auto=format&fit=crop&w=1200&q=80&sat=-20',
  ...
  {
    image: 'https://images.unsplash.com/photo-1519710164239-da123dc03ef4?auto=format&fit=crop&w=1200&q=80&sat=-30',
...
const updateKitchenActiveState = () => {
  ...
  const firstSlide = kitchenTrack.querySelector('.kitchen-slide');
  if (!firstSlide) return;
  const slideWidth = firstSlide.offsetWidth;
  const viewportWidth = slideWidth * KITCHEN_VISIBLE;
  const offsetPx = viewportWidth * currentKitchenIndex;
  kitchenTrack.style.transform = `translateX(-${offsetPx}px)`;
